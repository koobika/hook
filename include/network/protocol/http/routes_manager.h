...
//          `"""`            `"""`
// -----------------------------------------------------------------------------
// network/protocol/http/routes_manager.h
// -----------------------------------------------------------------------------
...
#ifndef koobika_hook_network_protocol_http_routesmanager_h
#define koobika_hook_network_protocol_http_routesmanager_h
...
class RoutesManager {
 public:
  ...
  virtual void Handle(const std::string& route, const RoutingHandler& handler,
  ...
  virtual void Options(const std::string& route,
                       const RoutingHandler& handler) = 0;
  // Adds a new <options> route to 'string-guided' router structures.
  virtual void Options(const std::string& route,
                       const RoutingHandlerExtended& handler_extended) = 0;
  // Adds a new <get> route to 'string-guided' router structures.
  virtual void Get(const std::string& route, const RoutingHandler& handler) = 0;
  // Adds a new <get> route to 'string-guided' router structures.
  ...
  virtual void Put(const std::string& route, const RoutingHandler& handler) = 0;
  // Adds a new <put> route to 'string-guided' router structures.
