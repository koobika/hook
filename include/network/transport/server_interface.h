...
//          `"""`            `"""`
// -----------------------------------------------------------------------------
// network/transport/server_interface.h
// -----------------------------------------------------------------------------
...
#ifndef koobika_hook_network_transport_serverinterface_h
#define koobika_hook_network_transport_serverinterface_h
...
class ServerInterface {
 public:
  ...
  virtual void Stop() = 0;
  // Tries to sends the specified auto-buffer through the transport connection.
  virtual bool Send(const HDty&, const base::AutoBuffer&) = 0;
};
}  // namespace koobika::hook::network::transport
