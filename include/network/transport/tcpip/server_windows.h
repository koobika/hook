...
//          `"""`            `"""`
// -----------------------------------------------------------------------------
// network/transport/tcpip/server_windows.h
// -----------------------------------------------------------------------------
...
#ifndef koobika_hook_network_transport_tcpip_serverwindows_h
#define koobika_hook_network_transport_tcpip_serverwindows_h
...
class Server : public ServerInterface<SOCKET, DEty> {
 public:
  ...
  void Start(const structured::json::Object& configuration,
    ...
    int number_of_workers = configuration[ServerConstants::kNumberOfWorkersKey];
