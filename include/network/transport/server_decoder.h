...
//          `"""`            `"""`
// -----------------------------------------------------------------------------
// network/transport/server_decoder.h
// -----------------------------------------------------------------------------
...
#ifndef koobika_hook_network_transport_serverdecoder_h
#define koobika_hook_network_transport_serverdecoder_h
...
class ServerDecoder {
 public:
  ...
  virtual void Decode(
      const transport::ServerDecoder<RQty, RSty>::RequestHandler&,
      const transport::ServerDecoder<RQty, RSty>::ErrorHandler&,
      const transport::ServerDecoder<RQty, RSty>::Sender&) = 0;
};
}  // namespace koobika::hook::network::transport
